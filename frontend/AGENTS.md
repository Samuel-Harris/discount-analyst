...
| `src/features/workflow-runs/`      | Run list/sidebar, right-hand launch rail, detail header, recommendations view (Curator book of current and recommended positions plus sortable lane-ratings table), run hooks (`useWorkflowRunActions`, navigation/detail/list/allocation). |
