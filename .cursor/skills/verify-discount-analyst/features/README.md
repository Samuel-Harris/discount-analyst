...
- [Recommendations book and lane ratings](./recommendations.md) covers the Curator book, lane-ratings table, filter, sort reset, and the `?view=recommendations` deep link.
