"""Structured output schema for the Surveyor agent."""
...
class SurveyorOutput(BaseModel):
    ...
    candidates: list[SurveyorCandidate] = Field(
        description=(
            "Ranked list of candidates. Aim for 15-25, but do not pad — "
            "a shorter list of strong candidates is better than a diluted one."
        ),
    )
