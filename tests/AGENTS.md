...
| `tests/shared/http/test_rate_limit_client.py` | Unit tests for streaming retry helpers (`should_retry_streaming_error`, sleep parsing, `stream_with_retries` history/usage on retry). |
