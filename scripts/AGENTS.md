...
| Directory          | Purpose                                                                                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `agents/`          | Entry points for Surveyor, Researcher, Strategist, Sentinel, and Appraiser workflows (`run_surveyor.py`, `run_researcher.py`, `run_strategist.py`, `run_sentinel.py`, `run_appraiser.py`). |
...
- Automated coverage includes pipeline and resolver checks where applicable. For end-to-end behaviour, run the CLIs with sample artefacts under `scripts/outputs/`.
