...
LSE_REPORTS_PAGES_FIXTURE = REGULATORY_DATA_FIXTURES / "lse" / "reports_pages.json"
LSE_INSTRUMENTS_REFRESH_FIXTURE = (
    REGULATORY_DATA_FIXTURES / "lse" / "instruments_refresh.json"
)
