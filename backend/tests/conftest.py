...
# Minimal defaults so ``discount_analyst.config.settings`` can import during tests
...
os.environ.setdefault("DEEPSEEK__API_KEY", "pytest-dummy-deepseek")
...
os.environ.setdefault("DASHBOARD_USE_TERMINAL", "false")
if os.environ.get("ENV") not in {None, "DEV", "PROD"}:
    os.environ["ENV"] = "DEV"
