...
| `tests/backend/unit/test_migration_startup.py`                          | Alembic head on startup, metadata verify, 0009→head agent-execution unify remap, and 0012→0013 allocation backfill (head is 0013).                 |
| `tests/backend/unit/test_portfolio_allocation_persistence.py`           | Workflow-create Surveyor+Allocator executions and allocation persist/reconstruct round-trip.                                                      |
