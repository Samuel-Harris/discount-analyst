...
from discount_analyst.adapters.persistence.crud.run_executions import (
    ...
    update_ticker_run_company_name as persist_ticker_run_company_name,
...
from discount_analyst.adapters.orchestration.stages.surveyor_stage import SurveyorStage
from discount_analyst.adapters.orchestration.stages.ticker_lane_stage import (
    TickerLaneStage,
)
...
class DashboardPipelineRunner:
    def __init__(self, session_factory: SessionFactory, settings: Settings) -> None:
        ...
        self._curator_stage = CuratorStage()
    ...
    async def update_ticker_run_company_name(
        ...
        await self.db(
            persist_ticker_run_company_name,
            run_id=run_id,
