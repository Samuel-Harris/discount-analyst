...
| File                    | Description                                                                                                                                               |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `agent_factory.py`      | `AgentSpec`, `create_agent`, `create_web_research_tooling` (bounded DuckDuckGo local web-search fallback; DeepSeek uses text-only `WebFetch` local tool). Always attaches Frankfurter `convert_currency` from `agents/tools/market_data/frankfurter.py`. |
