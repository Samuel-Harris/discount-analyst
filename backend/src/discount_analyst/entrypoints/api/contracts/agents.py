...
from discount_analyst.entrypoints.api.contracts.enums import AgentNameSlug
...
agent_configs: Final[list[AgentConfig]] = [
    ...
    AgentConfig(name=AgentName.ALLOCATOR, agent_name_slug=AgentNameSlug.ALLOCATOR),
]
